...
CREATE TABLE IF NOT EXISTS `categories` (
  ...
  `status` TINYINT UNSIGNED NOT NULL DEFAULT 0 COMMENT 'Le statut de la catégorie (1=active, 2=désactivée)',
...
CREATE TABLE IF NOT EXISTS `tasks` (
  ...
  `status` TINYINT UNSIGNED NOT NULL DEFAULT 0 COMMENT 'Le statut de la tâche (1=active, 2=archivée)',
